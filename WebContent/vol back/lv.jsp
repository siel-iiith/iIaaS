...
<div id="lvcontentWrapper" class="lvpageContent">
		<% 
			...
			String[] colors={"59,101,156", "245,153,0", "102,128,0", "204, 51, 51"};
			String[] colorsAttached = {"204, 51, 51", "102, 128, 0", "245,153,0", "245,153,0"};
	...
	<div id="<%="inst"+lv_i%>" style="display: none">
		<table style="margin-left: 100px;  padding: 30px;">
		<tr>
		<td style="width: 100px;">
